  ...
  render() {
    return (
      <div className="city_container">
        <Head
          headTitle={this.state.cityName}
          goBack
          changeCity={<Link to="/" className="change_city">切换城市</Link>}
        />
        ...
        {this.state.historytitle &&
          <header className="pois_search_history">搜索历史</header>}
        ...
        {this.state.placeNone &&
          <div className="search_none_place">很抱歉！无搜索结果</div>}
